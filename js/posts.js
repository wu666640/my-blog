/**
 * 博客文章数据
 * 每篇文章包含：id、title、date、excerpt、content（HTML）、tags
 */
const POSTS = [
  {
    id: 1,
    ...
    tags: ["生活", "咖啡"],
    content: `
      <p>每天下午两点，是我固定的咖啡时间。这个习惯已经保持了三年。</p>
      ...
      <blockquote>咖啡是流淌的哲学，每一杯都是一次小小的实验。</blockquote>
  ...
  },
  {
    ...
    content: `
      ...
      <blockquote>写作是一种抵抗——抵抗遗忘，抵抗浮躁，抵抗被算法定义。</blockquote>
  ...
  },
  {
    ...
    tags: ["技术", "Node.js"],
    content: `
      <p>最近在重构一个老项目，决定从零搭建一个新的 API 服务。这里记录一下我的搭建过程和一些思考。</p>
      <h2>项目初始化</h2>
...
└── types/        # 类型定义</code></pre>
  ...
  },
  {
    ...
    content: `
      ...
      <blockquote>慢下来，才能看见那些一直存在却被忽略的美好。</blockquote>
  ...
  },
  {
    ...
    tags: ["技术", "Git"],
    content: `
      <p>Git 是每个开发者的日常工具，但用好它并不简单。这篇文章总结了一些我在团队中实践的 Git 工作流。</p>
      <h2>分支策略</h2>
